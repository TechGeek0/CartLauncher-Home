                  ...
                  >
                    <div className="footer-contant">
                      <ul className="contact-details">
                        ...
                        <li>
                          Email Us: <Link to={null}>Support@Fiot.com</Link >
                        </li>
                        <li>Fax: 123456</li>
                      </ul>
                    </div>
                    ...
                    <div className="footer-link">
                      ...
                      >
                        <div className="footer-contant">
                          <ul>
                            <li>
                              <Link to={null}>mens</Link >
                            </li>
                            <li>
                              <Link to={null}>womens</Link >
                            </li>
                            <li>
                              <Link to={null}>clothing</Link >
                            </li>
                            <li>
                              <Link to={null}>accessories</Link >
                            </li>
                            <li>
                              <Link to={null}>featured</Link >
                            </li>
                          </ul>
                        </div>
                      </Collapse>
